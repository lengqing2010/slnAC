...
Partial Class P_TableEditor_m_edp_test2_temp
   ...
   tbxStatus2.Text = row.Cells(6).Text.Replace("&nbsp;", "")
    ...
    Protected Sub btnInsert_Click(sender As Object, e As System.EventArgs) Handles btnInsert.Click
        Dim sb As New StringBuilder
        With sb
            .AppendLine("INSERT INTO m_edp_test2")
            .AppendLine("(")
            .AppendLine("edp_no ")
            .AppendLine(",edp_mei ")
            .AppendLine(",edp_exp ")
    ...
    Protected Sub btnDelete_Click(sender As Object, e As System.EventArgs) Handles btnDelete.Click
        Dim sb As New StringBuilder
        With sb
            .AppendLine("DELETE FROM m_edp_test2")
            .AppendLine("WHERE")
        End With
        Dim DbResult As DbResult = DefaultDB.RunIt(sb.ToString)
        If Not DbResult.Result Then
