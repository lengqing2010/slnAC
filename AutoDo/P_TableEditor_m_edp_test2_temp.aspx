<%@ Page Language="VB" AutoEventWireup="false" CodeFile="P_TableEditor_m_edp_test2_temp.aspx.vb" Inherits="P_TableEditor_m_edp_test2_temp" %>
...
<table class='ms_title' style="width:732px" cellpadding="0" cellspacing="0">
   ...
   <tr>
       <td style="width:210px;">
<asp:TextBox ID="tbxEdpNo" class="jq_edp_no_ipt" runat="server" style="width:200px;"></asp:TextBox>
       </td>
       <td style="width:210px;">
