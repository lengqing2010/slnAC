<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AnkanSinntyokuJs.aspx.vb" Inherits="AnkanSinntyokuJs" %>
                ...
                for (i = 0; i <= 3; i++) {
                    ...
                    for (j = 0; j <= days; j++) {
                        ...
                        if (arrColsDay[j] == 6 || arrColsDay[j] == 0) {
                            $trTemp.append("<td nowrap='nowrap' class='r" + i + " c" + j + " yasumi_cell " + isTodayStyle + "'>" + rMs[i][j] + "</td>");
                        } else {
                            $trTemp.append("<td nowrap='nowrap' class='r" + i + " c" + j + " " + isTodayStyle + "'>" + rMs[i][j] + "</td>");
                        }
