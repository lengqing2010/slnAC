IF EXISTS(SELECT * 
          ...
          WHERE  id = Object_id('tempdb..#tmp0216k0854415735')) 
  BEGIN 
      DROP TABLE #tmp0216k0854415735 
  END 
...
WHERE  ltrim(tsj.truck_no) in('201711100653685','201711140653681')  
