...
IF EXISTS(SELECT * 
          ...
          WHERE  id = Object_id('tempdb..#tmp0216k0955108118')) 
  BEGIN 
      DROP TABLE #tmp0216k0955108118 
  END 
...
WHERE  tsj.truck_no in('201711100653685','201711140653681')  
...
ORDER BY main.truck_no,main.nouhin_yotei_date
