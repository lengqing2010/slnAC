...
-- ******************************
    ...
    SELECT tuh.tenpo_cd      --店コード
          ...
          ,(ISNULL(tuh.kingaku_02,0) + ISNULL(tuh.kingaku_credit,0) + ISNULL(tuh.kingaku_debit,0)) AS kake_kingaku
    ...
    tuh.genkin_gaikei,tuh.kingaku_credit,tuh.kingaku_debit,tuh.zei_goukei
