<%@ control language="VB" autoeventwireup="false" inherits="userctrl_WucTopBar, App_Web_rwbfootb" %>
...
<asp:LinkButton ID="lbtnAnnkenForuda" runat="server">案件フォルダ</asp:LinkButton>&nbsp;|&nbsp;
