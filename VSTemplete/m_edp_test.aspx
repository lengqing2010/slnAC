...
<asp:TextBox ID="tbxedpNo_key" class="" runat="server" style="width:200px;background-color: #FFAA00;"></asp:TextBox>
 ...
 <br> <hr />
      <table class='ms_title' style="width:816px" cellpadding="0" cellspacing="0">
          <tr>
              <td style="width:74px;">
                  ｉｎｄｅｘ
              </td>
...
<div id="divGvw" class='jq_ms_div' runat ="server" style="overflow:auto ; height:294px;margin-left:0px; width:836px; margin-top :0px; border-collapse :collapse ;">
   <asp:GridView CssClass ="jq_ms" Width="816px"  runat="server" ID="gvMs" EnableTheming="True" ShowHeader="False" AutoGenerateColumns="False" BorderColor="black" CellPadding="0" CellSpacing ="0" style=" margin-top :-1px; " TabIndex="-1" >
      <Columns>
